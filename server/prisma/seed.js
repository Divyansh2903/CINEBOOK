...
async function main() {
    ...
    const genre = (n) => genres.find((g) => g.name === n);
    // --- Movies ---
    console.log("Seeding movies…");
    const movieDefs = [
        {
            title: "Dune: Part Two", runtimeMin: 166, ageRating: "UA", language: "English",
            format: "THREE_D", trending: true, genres: ["Sci-Fi", "Action", "Drama"],
        ...
        {
            title: "Oppenheimer", runtimeMin: 180, ageRating: "A", language: "English",
            format: "TWO_D", trending: true, genres: ["Drama", "Thriller"],
        ...
        {
            title: "Inside Out 2", runtimeMin: 96, ageRating: "U", language: "English",
            format: "THREE_D", trending: true, genres: ["Animation", "Comedy"],
        ...
        {
            title: "Kalki 2898 AD", runtimeMin: 181, ageRating: "UA", language: "Hindi",
            format: "THREE_D", trending: false, genres: ["Sci-Fi", "Action"],
        ...
        {
            title: "A Quiet Place: Day One", runtimeMin: 99, ageRating: "UA", language: "English",
            format: "TWO_D", trending: false, genres: ["Horror", "Thriller"],
        ...
        {
            title: "The Fall Guy", runtimeMin: 126, ageRating: "UA", language: "English",
            format: "TWO_D", trending: false, genres: ["Action", "Comedy", "Romance"],
    ...
    const screenTypes = ["STANDARD", "IMAX", "FOUR_DX", "DOLBY_ATMOS"];
    const screens = [];
    ...
    void admin;
    console.log(`Done. ${movies.length} movies, ${screens.length} screens, ${showCount} shows, 3 users.`);
}
main()
    .catch((e) => {
    console.error(e);
